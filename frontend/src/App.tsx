...
function App() {
  ...
  const [babyHistories, setBabyHistories] = useState<Record<string, { time: string; heartRate: number; spo2: number; temp?: number; respRate?: number }[]>>({});
      ...
      if (mappedBabies.length > 0) {
        ...
        setBabyHistories(prev => {
          ...
          mappedBabies.forEach((b: any) => {
            ...
            updated[b.id] = [...historyList.slice(-19), { time: timeStr, heartRate: b.vitals.heartRate, spo2: b.vitals.spo2, temp: b.vitals.temp, respRate: b.vitals.respRate }];
          });
          return updated;
        });
              ...
              {liveBabies.map((baby: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Micro Vitals */}
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', width: '100%' }} onClick={e => e.stopPropagation()}>
                      ...
                      <div style={{ background: 'rgba(104, 178, 160, 0.04)', padding: '10px 12px', borderRadius: '10px', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: '2px' }}>
                        ...
                        <span className="technical-value" style={{ color: (baby.vitals?.spo2 < 95) ? 'var(--secondary)' : 'var(--text-main)', fontSize: '16px' }}>
                      ...
                      <div style={{ background: 'rgba(104, 178, 160, 0.04)', padding: '10px 12px', borderRadius: '10px', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: '2px' }}>
                        ...
                        <span className="technical-value" style={{ color: (baby.vitals?.temp > 37.5 || baby.vitals?.temp < 36.5) ? 'var(--secondary)' : 'var(--text-main)', fontSize: '16px' }}>
